...
router.route("/products/:id").put(verifyJWT, checkAdmin, updateProduct);
router.route("/products/:id").put(verifyJWT, checkAdmin, deleteProduct);

// Order Management (Admin Only)
router.route("/orders/").put(verifyJWT, checkAdmin, getAllOrders);
router
  .route("/orders/:orderId/status")
  .put(verifyJWT, checkAdmin, updateOrderStatus);
router.route("/orders/:orderId").put(verifyJWT, checkAdmin, cancelOrder);
